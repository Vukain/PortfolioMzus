...
export const useCarouseTransitionListener = ({ currentImage, length, motionNotReduced, sliderRef, setTransitionDuration, setCurrentImage, transitionDurationSwitch }: Parameters) => {
